...
const material = new THREE.MeshStandardMaterial({
  map: new THREE.TextureLoader().load('Images/dice.png'),
  color: 0xffffff 
});
...
//6 faces du dé
const dice1 = new THREE.TextureLoader().load("https://www.pngkey.com/detail/u2e6r5w7q8o0e6q8_dice-clipart-dice-side-dice-with-1/")
const dice2 = new THREE.TextureLoader().load('https://commons.wikimedia.org/wiki/File:Alea_2.png');
const dice3 = new THREE.TextureLoader().load('https://commons.wikimedia.org/wiki/File:Alea_3.png');
const dice4 = new THREE.TextureLoader().load('https://commons.wikimedia.org/wiki/File:Alea_4.png');
const dice5 = new THREE.TextureLoader().load('https://commons.wikimedia.org/wiki/File:Alea_5.png');
const dice6 = new THREE.TextureLoader().load('https://commons.wikimedia.org/wiki/File:Alea_6.png');
